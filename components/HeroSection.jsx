...
const HeroSection = ({ setBackgroundColor }) => {
  return (
    <section className="relative grid grid-cols-1  px-4 justify-evenly w-full h-full lg:flex lg:px-0 lg:justify-evenly lg:w-full lg:h-full border-2 border-green-700 ">
      {/* Left Part */}

      <div className="flex flex-col  justify-between border-2 border-red-600 items-center w-full h-full py-10  lg:items-start lg:w-[643px] lg:h-[593px] lg:mt-[77px] lg:py-0 ">
        <div className="flex flex-col justify-evenly w-full h-[311px] lg:justify-evenly lg:w-[643px] lg:h-[311px]">
          {/* Main Heading Text  */}

          <div className="flex flex-col w-full h-[217px]  space-y-0 lg:space-y-2 border-2 border-red-600 ">
            <div className="w-full h-[131px] flex flex-col  lg:items-start border-2 border-red-600 ">
          ...
          <div className="flex items-center  space-x-4 w-full h-[63px] lg:space-x-3 lg:w-[480px] lg:h-[63px] border-2 border-red-800">
        ...
        <div className="flex  flex-col justify-between border-2 border-red-600 w-full h-[227px] mt-[430px] lg:mt-0 lg:w-[400px] lg:h-[227px]">
          ...
          <div className="flex items-center justify-evenly border-2 border-blue-500 w-full h-[150px] lg:justify-between lg:w-[400px] lg:h-[150px]">
